(function() {
    ...
    var W = (function() {
        ...
        function b(g) {
            C[g.solarYear - 2016].selected = true;
    ...
    var N = (function() {
        function C() {
            ...
            for (var a = 0; a < c.length; a++) {
                ...
                var X = R("DIV");
                if (c[a].isToday) {
                    X.style.border = "1px solid #ff6c60";
                    //X.style.background = "#76cecd"
                }
                X.className = "cell";
                ...
                b.style.color = ((a % 7) > 4 || c[a].isRest) ? "#ff6c60": "#313131";
