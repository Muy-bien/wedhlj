...
$(document).ready(function(){
	...
	$.ajax({
		...
		data: data,
		success:function(e){
			$(".info_logo").html('<div class="img_auto" style="background-image:url('+e.mLogo+')"></div>');//商家logo
            ...
            $(".info_but_02").hover(
                function(){
                    $(this).html("<span>商家电话</span><br>"+e.mCpphone);
                    $(this).addClass('info_but_02_on');
                },
                function(){
                    $(this).html("联系商家");
                    $(this).removeClass('info_but_02_on');
                }
            )
			//推荐商品(广告)
            var attr = "" 
            for(var x=0;x<e.list1.length;x++){
                ...
                '<div class="main_rcont_x10"><div class="img_auto" style="background-image:url('+tpimg[0]+')"></div></div>'+
            ...
            for(var c=0;c<gdsp_length;c++){
                ...
                '<div><div>'+
                '<div class="img_auto" style="background-image:url('+gdsp_img[0]+')"></div>'+
