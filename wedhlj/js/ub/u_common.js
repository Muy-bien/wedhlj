			...
			'<ul class="nav_cont">'+
				'<li>'+
					...
					'<div class="nav_cont_a nav_cont_off person">'+
						'<a href="c_mainCheck.html?type=0&AuditStatus=-1&pageNo=1">用户基本资料审核</a>'+
					'</div>'+
				'</li>'+
				'<li>'+
					'<i></i>'+
					'<div class="nav_cont_a nav_cont_off merchant">'+
						'<a href="c_mainCheck.html?type=1&AuditStatus=-1&pageNo=1">人员审核</a>'+
					'</div>'+
				'</li>'+
				'<li>'+
					'<i></i>'+
					'<div class="nav_cont_a nav_cont_off hotel">'+
						'<a href="c_mainCheck.html?type=2&AuditStatus=-1&pageNo=1">策划审核</a>'+
					'</div>'+
				'</li>'+
				'<li>'+
					'<i></i>'+
					'<div class="nav_cont_a nav_cont_off hotel">'+
						'<a href="c_mainCheck.html?type=3&AuditStatus=-1&pageNo=1">商品审核</a>'+
					'</div>'+
				'</li>'+
				'<li>'+
					'<i></i>'+
