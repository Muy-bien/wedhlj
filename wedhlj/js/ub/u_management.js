		...
		for(var i=0;i<data.productList.length;i++){
			...
			str +='<ul>'+
				...
				'<li>'+
					...
					'<button onclick="turnShop('+productList.productNo+','+(productList.productType=="舞美"?0:1)+')">查看</button>'+
...
function turnShop(productNo,type){
	window.open("b_Addorder.html?productNo="+productNo+"&type="+(type==0?"舞美":"道具"));
}
